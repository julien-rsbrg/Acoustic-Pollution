...
def your_optimization_procedure(domain_omega, spacestep, omega, f, f_dir, f_neu, f_rob,
                           ...
                           Alpha, mu, chi, V_obj, S, mu1 = 0, V_0 = 1, numb_iter = 100):
    ...
    while k < numb_iter and mu > eps0:
        ...
        q = processing.solve_helmholtz(domain_omega, spacestep, omega,
                    f_adjoint, f_dir, f_neu, f_rob,
                    beta_pde, alpha_pde, alpha_dir, beta_neu, beta_rob, alpha_rob)
        print('4. computing parametric gradient')
        grad = numpy.real(Alpha*u*q)
        print('3. computing objective function, i.e., energy')
        energy[k] = your_compute_objective_function(domain_omega, u, spacestep, mu1, V_0)
        ene = energy[k]
        chi = chi - mu*grad
